...
def region_to_index():
    df = pd.read_excel("Data_v3_process.xlsx", sheet_name='shopping_mall', usecols=[6],names=None,keep_default_na=False)
...
for col in range(1,6):
    df = pd.read_excel("Data_v3_process.xlsx", sheet_name='shopping_mall', usecols=[col],names=None,keep_default_na=False)
    df_li = df.values.tolist()
    data = []
    result = []
    new = []
...
#read rating
df_rating = pd.read_excel("Data_v3_process.xlsx", sheet_name='shopping_mall', usecols=[8],names=None,keep_default_na=False)
